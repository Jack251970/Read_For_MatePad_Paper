...
-keep class com.jack.bookshelf.widget.**{*;}
-keep class com.jack.bookshelf.bean.**{*;}
...
# 2022/7/24日修改-keep class javax.swing..**{*;}为-keep class javax.swing.**{*;}
...
-keep public class com.jack.bookshelf.R$*{
