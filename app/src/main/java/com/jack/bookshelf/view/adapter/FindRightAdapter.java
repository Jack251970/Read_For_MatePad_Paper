...
import com.jack.bookshelf.view.activity.ChoiceBookActivity;
import com.jack.bookshelf.widget.recycler.expandable.OnRecyclerViewListener;
import com.jack.bookshelf.widget.recycler.expandable.bean.RecyclerViewData;
import com.jack.bookshelf.widget.recycler.sectioned.SectionedRecyclerViewAdapter;
...
public class FindRightAdapter extends SectionedRecyclerViewAdapter<FindRightAdapter.HeaderHolder, FindRightAdapter.DescHolder, RecyclerView.ViewHolder> {
    private final List<RecyclerViewData> data = new ArrayList<>();
    private final LayoutInflater inflater;
    private final Context context;
    private final OnRecyclerViewListener.OnItemLongClickListener onItemLongClickListener;
