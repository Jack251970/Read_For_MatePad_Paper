...
import static com.jack.bookshelf.help.FileHelp.BLANK;
...
public class PageLoaderText extends PageLoader {
    ...
    private final List<String> chapterPatterns = new ArrayList<>();
    //章节解析模式
                ...
                .subscribe(new SingleObserver<>() {
                    ...
                    public void onSuccess(List<BookChapterBean> value) {
                        ...
                        if (binding.tvChapterName.getVisibility() == View.VISIBLE) {
                            binding.tvChapterName.setText(value.get(mPageLoader.getCurChapterPos()).getDurChapterName());
                        }
                    }
