package com.jack.bookshelf.widget.recycler.expandable;

import static com.jack.bookshelf.widget.recycler.expandable.BaseExpandAbleViewHolder.VIEW_TYPE_CHILD;
import static com.jack.bookshelf.widget.recycler.expandable.BaseExpandAbleViewHolder.VIEW_TYPE_PARENT;
...
import com.jack.bookshelf.widget.recycler.expandable.bean.BaseItem;
import com.jack.bookshelf.widget.recycler.expandable.bean.GroupItem;
...
public abstract class BaseExpandableRecyclerAdapter<T, S, VH extends BaseExpandAbleViewHolder> extends RecyclerView.Adapter<VH> {
     ...
     * showing datas
     */
    private final List showingDatas = new ArrayList<>();
