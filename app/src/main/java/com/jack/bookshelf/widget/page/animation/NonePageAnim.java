package com.jack.bookshelf.widget.page.animation;
...
/**
 * Page Animation Without Any Animation
 * Edited by Jack251970
 */

public class NonePageAnim extends PageAnimation {
    ...
    public void drawMove(Canvas canvas) {canvas.drawBitmap(bitmapList.get(1), 0, 0, null);}
    ...
    public void setNoNext(boolean noNext) {this.noNext = noNext;}
}