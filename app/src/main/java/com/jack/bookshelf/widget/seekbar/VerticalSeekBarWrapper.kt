package com.jack.bookshelf.widget.seekbar
...
class VerticalSeekBarWrapper @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
