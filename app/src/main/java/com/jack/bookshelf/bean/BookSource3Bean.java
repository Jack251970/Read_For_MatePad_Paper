...
public class BookSource3Bean {
    private final String bookSourceName = "";                // 名称
    private String bookSourceGroup;            // 分组
    private final String bookSourceUrl = "";            // 地址，包括 http/https
    private final int bookSourceType = 0;    // 类型，0 文本，1 音频
    private String bookUrlPattern;            // 详情页url正则
    private final int customOrder = 0;                      // 手动排序编号
    private final Boolean enabled = true;                    // 是否启用
    private final Boolean enabledExplore = true;             // 启用发现
    private String header;                     // 请求头
    private String loginUrl;                   // 登录地址
    private String loginUi;
    private String loginCheckJs;
    private String bookSourceComment;            // 注释
    private final Long lastUpdateTime = 0L;               // 最后更新时间，用于排序
    private final int weight = 0;                            // 智能排序的权重
