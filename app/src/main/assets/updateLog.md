...
***此应用仅适配Huawei Matepad Paper,不适配其余设备！***

**[已知问题]**
* 目录正则启用过多会出现无法点击管理目录正则的问题
* 暗黑模式下编辑书源、搜索书籍界面会出现字体颜色与背景颜色相同的问题

***2022/10/02***
* 删除了RecycleRefreshView下的加载动画
* 修复了主界面下书籍排序规则无法切换的问题
...
* 优化了切换书架布局的速度
* 重新整合了书源编辑的板块使之更加清晰
* 修复了书源分享时Vip标识与购买标识规则无法分享的问题
* 重新绘制了Permission内的Dialog使之符合华为墨水屏设备风格
* 重新整理并绘制了书源编辑界面使之易于读写
